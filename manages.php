...
if ($_SERVER["REQUEST_METHOD"] == "POST" && isset($_POST['admin_email'])) {
    ...
    if ($result_check_admin->num_rows > 0) {
        // Admin found, proceed with further logic
        ...
        <form action="" method="post">
            ...
            <select id="equipment_name" name="equipment_name" required>
                <?php
                // Retrieve equipment names from Inventory table
    ...
    if ($_SERVER["REQUEST_METHOD"] == "POST" && isset($_POST['equipment_name'])) {
        ...
        if ($result_check_admin->num_rows > 0) {
            // Admin exists, proceed with inventory management
            // Check if this type of equipment has already been managed today

...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    // Get the customer username from the form
    ...
    // If no rows are returned, it means the customer does not exist
    // You can use your preferred database connection method here
...
<div class="purchase-form">
    <form method="post" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>">
        ...
        <label for="plan1">Plan 1</label><br>
        <input type="radio" name="plan_id" value="2" id="plan2">
        <label for="plan2">Plan 2</label><br><br>
